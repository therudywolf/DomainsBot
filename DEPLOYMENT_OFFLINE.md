...
**Настройка:**
1. Создайте файл `wg/wg0.conf` с конфигурацией WireGuard на хосте (образ ожидает именно имя **wg0.conf**; при необходимости скопируйте или переименуйте свой конфиг в `wg0.conf`)
